...
with gr.Blocks() as demo:
    ...
    with gr.Tab("2. Transcriber Settings"):
        ...
        whisper_model = gr.Dropdown(["tiny", "base", "small", "medium", "large"], label="Whisper model", value="base")
    ...
    with gr.Tab("3. Result & Save"):
        ...
        save_btn.click(on_save, inputs=[transcript, save_path], outputs=save_status)
